...
describe("captureTarget utilities", () => {
    ...
    it("finds mutually exclusive process and process-tree peers", () => {
        expect(captureTargetPeerId(processCaptureId(42))).toBe(processTreeCaptureId(42));
        expect(captureTargetPeerId(processTreeCaptureId(42))).toBe(processCaptureId(42));
    ...
    it("formats capture target mode labels", () => {
        ...
        expect(captureTargetModeLabel(processTreeCaptureId(42))).toBe("Process tree");
